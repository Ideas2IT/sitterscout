...
#    get :accepted, :user_id => users(:user_986324922).id
...
#        post :create, :user_id => users(:user_986324922).id, :friend_id => users(:kevin).id 
#      end
#    end
#    assert_redirected_to accepted_user_friendships_path(users(:user_986324922))
#  end
#
...
#      post :create, :user_id => users(:user_986324922).id, :friend_id => nil
#    end
#    assert_redirected_to user_friendships_path(users(:user_986324922))
#  end
...
#    login_as :user_986324922
#    assert_difference Friendship, :count, -2 do
#      delete :destroy, :id => 1, :user_id => users(:user_986324922).id
#      assert_redirected_to accepted_user_friendships_path(:user_id => users(:user_986324922))
#    end
#  end
