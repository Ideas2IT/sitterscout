...
#    get :index, :user_id => users(:user_986324922).id
#    assert_response :success
#    assert assigns(:invitations)
  end

  def test_should_get_new
    get :new, :user_id => users(:patrick).id
    assert_response :success
  end
  ...
  #      post :create, :user_id => users(:user_986324922).id, :invitation => {:message => 'sup dude', :email_addresses => 'asdf@asdf.com' }, :welcome => 'complete'
  #      assert_redirected_to welcome_complete_user_path(users(:user_986324922))
  #    end    
  end
...
#    login_as :user_986324922
#    assert_difference Invitation, :count, 1 do
#      post :create, :user_id => users(:user_986324922).id, :invitation => {:message => 'sup dude', :email_addresses => 'asdf@asdf.com' }
#      assert_redirected_to user_path(users(:user_986324922))
#    end    
#  end
#
...
#      post :create, :user_id => users(:user_986324922).id, :invitation => {:message => 'sup dude', :email_addresses => nil }
#    end    
#    assert_response :success
