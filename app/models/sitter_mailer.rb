class SitterMailer < ActionMailer::Base
      ...
      def job_notice(sitter_email, parent, message="You have a job request.")
            content_type "text/html"
         setup_sender_info
        @recipients = "#{sitter_email}"
      ...
      def signup_notification(user)
        ...
        @body[:url]  = "#{APP_URL}/sitters/activate/#{user.activation_code}"
      end
