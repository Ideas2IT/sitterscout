...
lightbox.prototype = {
	...
	initialize: function(ctrl) {
		...
		ctrl.onclick = function(){ 
			...
			if(dim.length > 4)
			{
				...
				$('lightbox').style.width = dim.substring(5, (x)) + "px";
				$('lightbox').style.height = (Number(dim.substring(Number(x)+1))) +"px";
			}
			return false;
	...
	intialize_for_js_call: function(href) {
...
function initialize(){
	...
	for(i = 0; i < lbox.length; i++) {
		if(lbox[i].className.substring(0,4) == 'lbOn')
		{
